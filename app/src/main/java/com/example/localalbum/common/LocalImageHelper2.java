 ...
 */
public class LocalImageHelper2 {
    private static LocalImageHelper2 instance;
    ...
    private LocalImageHelper2(AppContext context) {
    ...
    public static LocalImageHelper2 getInstance() {
        return instance;
    }

    public static void init(AppContext context) {
        instance = new LocalImageHelper2(context);
